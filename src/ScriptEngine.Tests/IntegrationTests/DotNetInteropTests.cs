...
function testFunc() { return Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass; }");
			HappyTypeTracker tracker = context.Globals.testFunc();

			Assert.AreEqual("Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass", tracker.FullName);
		}
		[Test]
...
");
		...
		[Test]
		[Category(TestCategories.RuntimeErrorHandling)]
...
@"load ""Happy.ScriptEngine.Tests"";
function testFunc()
{ return Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.NonExistentMethod(); }
");
...
@"load ""Happy.ScriptEngine.Tests"";
function testFunc()
{ return Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.SomeStaticMethod(1.0); }
");
			Assert.Throws<MissingMemberException>(() => context.Globals.testFunc());
		}
		...
		public void SetStaticProperty()
		{
			...
			HappyRuntimeContext context = base.CompileModule(@"
load ""Happy.ScriptEngine.Tests"";
function testFunc() { Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.StaticA = 111; }");
		...
		public void GetStaticProperty()
		{
			...
			HappyRuntimeContext context = base.CompileModule(@"
load ""Happy.ScriptEngine.Tests"";
function testFunc() { return Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.StaticA; }");
		...
		public void GetIntConstant()
		{
			...
			HappyRuntimeContext context = base.CompileModule(@"
load ""Happy.ScriptEngine.Tests"";
function testFunc() { return Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.SomeIntConstant; }");
		...
		public void GetStringConstant()
		{
			...
			HappyRuntimeContext context = base.CompileModule(@"
load ""Happy.ScriptEngine.Tests"";
function testFunc() { return Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.SomeStringConstant; }");
...
function testFunc() { return Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.StaticA; }");
		...
		public void NewTestClass()
		{
			HappyRuntimeContext context = base.CompileModule(@"
load ""Happy.ScriptEngine.Tests"";
function testFunc() { return new(Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass); }
");
			object temp = context.Globals.testFunc();
		...
		public void NewTestClassWithConstructorArgs()
		{
			HappyRuntimeContext context = base.CompileModule(@"
load ""Happy.ScriptEngine.Tests"";
function testFunc() { return new(Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass, 1, 2); }
");
			object temp = context.Globals.testFunc();
		...
		public void NewTestStruct()
		{
			HappyRuntimeContext context = base.CompileModule(@"
load ""Happy.ScriptEngine.Tests"";
function testFunc() { return new(Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestStruct2, 1, 2); }
");
			object temp = context.Globals.testFunc();
		...
		public void GetEnum()
		{
			HappyRuntimeContext context = base.CompileModule(@"
load ""Happy.ScriptEngine.Tests"";
function testFunc() { return Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestEnum; }
");
			object temp = context.Globals.testFunc();
		...
		public void GetEnumValues()
		{
			HappyRuntimeContext context = base.CompileModule(@"
load ""Happy.ScriptEngine.Tests"";
function testFunc0() { return Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestEnum.Zero; }
function testFunc1() { return Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestEnum.One; }
function testFunc2() { return Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestEnum.Two; }
");
		...
		public void GetClassEnum()
		{
			HappyRuntimeContext context = base.CompileModule(@"
load ""Happy.ScriptEngine.Tests"";
function testFunc() { return Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.TestClassEnum; }
");
			object temp = context.Globals.testFunc();
			Assert.AreEqual(typeof(HappyTypeTracker), temp.GetType());
		}
		...
		public void GetClassEnumValues()
		{
			HappyRuntimeContext context = base.CompileModule(@"
load ""Happy.ScriptEngine.Tests"";
function testFuncA() { return Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.TestClassEnum.A; }
function testFuncB() { return Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.TestClassEnum.B; }
function testFuncC() { return Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.TestClassEnum.C; }
");
...
");
		...
		public void StaticPropertyGetArrayIndex()
		{
			...
			HappyRuntimeContext context = base.CompileModule(@"
load ""Happy.ScriptEngine.Tests"";
function testFunc1() { return Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.StaticTestArray[0]; }
function testFunc2() { return Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.StaticTestArray[1]; }
function testFunc3() { return Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.StaticTestArray[2]; }
function testFunc4() { return Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.StaticTestArray[3]; }
");
		...
		public void StaticPropertySetArrayIndex()
		{
			...
			HappyRuntimeContext context = base.CompileModule(@"
			load ""Happy.ScriptEngine.Tests"";
			function testFunc(index, value) { Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.StaticTestArray[index] = value; }");
		...
		public void CallOverloadedStaticMethodWithNoParameters()
		{
			const string moduleToParse = @"
load ""Happy.ScriptEngine.Tests"";
function testFunc1(){ Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.SomeStaticMethod(); }
";
			HappyRuntimeContext rc = CompileModule(moduleToParse);
		...
		public void CallOverloadedStaticMethodWithIntParameter()
		{
			const string moduleToParse = @"
load ""Happy.ScriptEngine.Tests"";
function testFunc1(){ Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.SomeStaticMethod(123); }
";
			HappyRuntimeContext rc = CompileModule(moduleToParse);
		...
		public void CallOverloadedStaticMethodWithBoolParameter()
		{
			const string moduleToParse = @"
load ""Happy.ScriptEngine.Tests"";
function testFunc1(){ Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.SomeStaticMethod(true); }
";
			HappyRuntimeContext rc = CompileModule(moduleToParse);
		...
		public void CallOverloadedStaticMethodWithStringParameter()
		{
			const string moduleToParse = @"
load ""Happy.ScriptEngine.Tests"";
function testFunc1(){ Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.SomeStaticMethod(""1143""); }
";
			HappyRuntimeContext rc = CompileModule(moduleToParse);
		...
		public void CallOverloadedStaticMethodWithDifferentParameters()
		{
			const string moduleToParse = @"
load ""Happy.ScriptEngine.Tests"";
function testFunc1(parameter){ Happy.ScriptEngine.Tests.IntegrationTests.TestTypes.TestClass.SomeStaticMethod(parameter); }
";
			HappyRuntimeContext rc = CompileModule(moduleToParse);
