...
{
	def var1 = 123;
	return (null != var1); /*TODO:  FIX null on left site bug! (parens are a workaround)*/
}
");
            Assert.IsTrue(rc.Globals.main());
            Assert.IsTrue(rc.Globals.main2());
		}

		[Test]
		public void NotNullLocalInt16()
		{
			HappyRuntimeContext rc = CompileModule(@"
function main()
{
...
function main2()
{
	def var1 = System.Convert.ToInt16(123); 
    return (null != var1); /*TODO:  FIX null on left site bug! (parens are a workaround)*/
}
");
            Assert.IsTrue(rc.Globals.main());
...
function main()
{
/*TODO:  FIX null on left site bug! */
    return (null == null); 
}
");
            Assert.IsTrue(rc.Globals.main());
...
~output;
";
			Assert.AreEqual("I am a template.", Execute(actual, "output"));
		}

//		[Test]
//		public void AnonymousTemplate_NoSemicolon()
//		{
//			const string actual = @"
//def anon = ""anonymous"";
//def output = <|$anon$.|>;
